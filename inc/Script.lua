...
redis:set(sela.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(sela..'lock:join:'..msg.chat_id_,true)
...
redis:del(sela..'lock:join:'..msg.chat_id_)
return "*↯ أهلا عزيزي *"..msg.TheRankCmd.."*\n↯ تم فتح الدخول بالرابط \n*" 
end


local function isela(msg,MsgText)

Channel = redis:get(sela..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(sela..'joinchnl') then
...
redis:set(sela.."getidstatus"..msg.chat_id_, "Photo")
redis:set(sela..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
redis:setex(sela..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(sela..'CheckExpire::'..msg.chat_id_) then 
redis:set(sela..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(sela..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(sela..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(sela..'CheckExpire::'..msg.chat_id_) then 
redis:set(sela..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(sela..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(sela..'CheckExpire::'..msg.chat_id_) then 
redis:set(sela..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(sela..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(sela..'CheckExpire::'..msg.chat_id_) then 
redis:set(sela..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(sela..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(sela..'group:name'..msg.chat_id_) or '')
redis:set(sela..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(sela..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. sela..'')
...
return sendMsg(msg.chat_id_,msg.id_,'\n↯ ًاهلا عزيزي البوت هنا ادمن بالقروب \n↯ وصلاحياته هي ↓ \nــــــــــــــــــــــــــــــــ 𖠲 𖠲 𖠲ـــــــــــــــــــــــــ\n↯ تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n↯ حذف الرسائل ↞ 𖠲 ❪ '..delete..' ❫\n↯ حظر المستخدمين ↞ 𖠲 ❪ '..restrict..' ❫\n↯ دعوة مستخدمين ↞ 𖠲 ❪ '..invite..' ❫\n↯ تثبيت الرسائل ↞ 𖠲 ❪ '..pin..' ❫\n↯ اضافة مشرفين جدد ↞ 𖠲 ❪ '..promote..' ❫\n\n↯ ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
if not msg.Director and redis:get(sela..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(sela..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(sela..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(sela..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(sela..'admins:'..msg.chat_id_)
redis:del(sela..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(sela..'owners:'..msg.chat_id_)
redis:del(sela..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(sela..'whitelist:'..msg.chat_id_)
redis:del(sela..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(sela..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(sela..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(sela..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(sela..'linkGroup'..msg.sender_user_id_,300,true)
return '↯ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(sela..'linkGroup'..msg.chat_id_) then 
return "↯ اوه لا يوجد رابط .\n↯لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(sela..'group:name'..msg.chat_id_)
local GroupLink = redis:get(sela..'linkGroup'..msg.chat_id_)
...
local Text = "↯ رابـط الـمـجـمـوعه ↯ \n"..Flter_Markdown(redis:get(sela..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(sela..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(sela..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "↯ عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(sela..':Filter_Word:'..msg.chat_id_)
...
redis:del(sela..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(sela..'welcome:msg'..msg.chat_id_) then 
return "↯ اوه هنالك خطأ .\n↯ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(sela..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(sela..':Hussain:'..msg.chat_id_)
redis:del(sela..':Hussain:'..msg.chat_id_)
...
if not msg.Kara then return "✲¦ هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local NumMnsha = redis:scard(sela..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(sela..':MONSHA_BOT:'..msg.chat_id_)
...
redis:del(sela..'banned:'..msg.chat_id_)
return "↯أهلا عزيزي "..msg.TheRankCmd.."   \n↯  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(sela..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "↯ لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(sela..'is_silent_users:'..msg.chat_id_)
...
redis:del(sela..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "↯هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(sela..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(sela..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "↯هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(sela..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(sela..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(sela..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(sela..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(sela..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(sela..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(sela..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(sela..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(sela.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'︙⌔ 𖡗𝙽𝙰𝙼𝙴  ⚘   '..Namei..'     \n︙⌔↯ 𝚄𝚂𝙴𝚁 ⚘ '..UserNameID..' .\n︙⌔𖡗 𝙼𝚂𝙶𝙴 ⚘ '..msgs..' .\n︙⌔↯ 𝚂𝚃𝙰  ⚘ '..msg.TheRank..' .\n𖤏 𝙸𝙳 ࿖ '..msg.sender_user_id_..' \n⚘ 𝚌𝚑 𖠪 @teamsela .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(sela..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(sela..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(sela..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(sela..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(sela..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(sela..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(sela..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(sela..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "↯تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '↯  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "↯عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(sela..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "↯عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(sela..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
.."—————— 𖠲 𖠲 𖠲———————\n"
.."↯ 𖠲 الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."↯ 𖠲 المعرف ( "..ResolveUser(data).." )\n"
.."↯ 𖠲 الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."↯ 𖠲 رتبتك ( "..msg.TheRank.." )\n"
.."↯ ـ ( `"..msg.chat_id_.."` )\n"
.."———————— 𖠲 𖠲 𖠲————————\n"
.." ↯ 𖠲 الأحصائيات الرسائل .\n"
.."↯ 𖠲 الرسائل ( `"..msgs.."` )\n"
.."↯ 𖠲 الجهات ( `"..NumGha.."` )\n"
.."↯ 𖠲 الصور ( `"..photo.."` )\n"
.."↯ 𖠲 المتحركه ( `"..animation.."` )\n"
.."↯ 𖠲 الملصقات ( `"..sticker.."` )\n"
.."↯ 𖠲 البصمات ( `"..voice.."` )\n"
.."↯ 𖠲 الصوت ( `"..audio.."` )\n"
.."↯ 𖠲 الفيديو ( `"..video.."` )\n"
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(sela..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(sela..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(sela..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(sela..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(sela..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(sela..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(sela..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(sela..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)

local Get_info ="↯ 𖠲 أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(sela..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(sela..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(sela..'welcome:msg'..msg.chat_id_))
else 
return "↯أهلا عزيزي "..msg.TheRankCmd.."  \n↯ نورت المجموعه \n" 
end 
end
...
if not msg.Admin then return "↯ 𖠲هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Creator then return "↯ 𖠲هذا الامر يخص {المطور,المنشئ} فقط  \n" end
...
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(sela..':SUDO_BOT:')
if mtwren == 0 then  return "↯ 𖠲 عذراً لا يوجد مطورين في البوت ." end
redis:del(sela..':SUDO_BOT:') 
return "↯ 𖠲 تم مسح {* "..mtwren.." *} من المطورين .\n"
end

if MsgText[1] == 'مسح' and MsgText[2] == "قائمه العام"  then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
local addbannds = redis:scard(sela..'gban_users')
if addbannds ==0 then 
return "*↯ 𖠲 قائمة الحظر فارغه .*" 
end
redis:del(sela..'gban_users') 
return "↯ 𖠲 تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عدد المجموعات ↯⊱ { *'..#groups..'*  } ⊰↯\n↯ 𖠲 تـم تنظيف  ↯⊱ { *'..GroupDel..'*  } ⊰↯ مجموعه \n↯ 𖠲 اصبح العدد الحقيقي الان ↯⊱ { *'..GroupsIsFound..'*  } ⊰↯ مجموعه')
end
end
end)
end
...
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عدد المشتركين ↯⊱ { *'..#pv..'*  } ⊰↯\n↯ 𖠲 تـم تنظيف  ↯⊱ { *'..NumPvDel..'*  } ⊰↯ مشترك \n↯ 𖠲 اصبح العدد الحقيقي الان ↯⊱ { *'..SenderOk..'*  } ⊰↯ من المشتركين') 
end
end
end)
end)
...
redis:setex(sela..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(sela..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[↯ اهلا انا بوت]]..redis:get(sela..':NameBot:')..[[ .
...
redis:setex(sela..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '↯ حسننا عزيزي .\n↯ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(sela..':addnumberusers',MsgText[2]) 
return '↯ 𖠲 تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'↯ 𖠲 شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(sela..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات" then
if not msg.SudoUser then return "↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
return '↯ عدد المجموعات المفعلة » `'..redis:scard(sela..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين" then
if not msg.SudoUser then return "↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
return '↯عدد المشتركين في البوت : `'..redis:scard(sela..'users')..'` \n'
end

if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
return chat_list(msg) 
end

if MsgText[1] == 'تعطيل' and MsgText[2] and MsgText[2]:match("-100(%d+)") then
if not msg.SudoUser then return "↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(sela..'group:ids',MsgText[2]) then
local name_gp = redis:get(sela..'group:name'..MsgText[2])
sendMsg(MsgText[2],0,'↯ 𖠲 تم تعطيل المجموعه بأمر من المطور  \n↯ 𖠲 سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '↯ 𖠲 تم تعطيل المجموعه ومغادرتها \n↯ المجموعة » ['..name_gp..']\n↯ 𖠲 الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '↯ 𖠲 لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 

if MsgText[1] == 'المطور' then
return redis:get(sela..":TEXT_SUDO") or '↯ لا توجد كليشه المطور .\n↯ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه" then
if not msg.SudoUser then return"↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(sela..'lock_brod') then 
return "↯ 𖠲 الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(sela..'fwd:'..msg.sender_user_id_,300, true) 
return "↯ 𖠲 حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
redis:setex(sela..'fwd:all'..msg.sender_user_id_,300, true) 
return "↯ 𖠲 حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
redis:setex(sela..'fwd:pv'..msg.sender_user_id_,300, true) 
return "↯ 𖠲 حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
redis:setex(sela..'fwd:groups'..msg.sender_user_id_,300, true) 
return "↯ 𖠲 حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
redis:del(sela..'welcom:witting'..msg.sender_user_id_,
sela..'rulse:witting'..msg.sender_user_id_,
sela..'rulse:witting'..msg.sender_user_id_,
sela..'name:witting'..msg.sender_user_id_,
sela..'about:witting'..msg.sender_user_id_,
sela..'fwd:all'..msg.sender_user_id_,
sela..'fwd:pv'..msg.sender_user_id_,
sela..'fwd:groups'..msg.sender_user_id_,
sela..'namebot:witting'..msg.sender_user_id_,
sela..'addrd_all:'..msg.sender_user_id_,
sela..'delrd:'..msg.sender_user_id_,
sela..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
sela..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
sela..'addrd:'..msg.sender_user_id_,
sela..'delrdall:'..msg.sender_user_id_,
sela..":ForceSub:"..msg.sender_user_id_,
sela..'text_sudo:witting'..msg.sender_user_id_,
sela..'addrd:'..msg.chat_id_..msg.sender_user_id_,
sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/sela.github.io/master/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(sela..":VERSION",GetVerison)
return false
else
...
return 'ٴ𐄬 اصدار سورس برايدن ♡ *v'..version..'* \n'
end



if MsgText[1] == 'نسخه احتياطيه للمجموعات' then
if not msg.SudoBase then return"↯ 𖠲 *│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"↯ 𖠲 عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سيلا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
...
if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي 𖠲") and msg.type == "pv" then return  "\n↯ اهلاً عزيزي المطور ايديك :\n\n↯ "..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس" and msg.type == "pv" then
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Braidn_1"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : برايدن](https://t.me/Braidn_1)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '↯ 𖠲 الاحصائيات . \n\n↯ 𖠲عدد المجموعات المفعله : '..redis:scard(sela..'group:ids')..'\n↯عدد المشتركين في البوت : '..redis:scard(sela..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام" then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(sela..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "↯ حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(sela..'replay:'..msg.chat_id_)
local photo 	= redis:exists(sela..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(sela..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(sela..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(sela..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(sela..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(sela..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(sela..'replay:'..msg.chat_id_,sela..'replay_photo:group:'..msg.chat_id_,sela..'replay_voice:group:'..msg.chat_id_,
sela..'replay_animation:group:'..msg.chat_id_,sela..'replay_audio:group:'..msg.chat_id_,sela..'replay_sticker:group:'..msg.chat_id_,sela..'replay_video:group:'..msg.chat_id_)
return "↯ 𖠲 تم مسح كل الردود ."
else
return '↯ 𖠲 لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"↯ 𖠲 للمطورين فقط ." end
local names 	= redis:exists(sela..'replay:all')
local photo 	= redis:exists(sela..'replay_photo:group:')
local voice 	= redis:exists(sela..'replay_voice:group:')
local imation 	= redis:exists(sela..'replay_animation:group:')
local audio 	= redis:exists(sela..'replay_audio:group:')
local sticker 	= redis:exists(sela..'replay_sticker:group:')
local video 	= redis:exists(sela..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(sela..'replay:all',sela..'replay_photo:group:',sela..'replay_voice:group:',sela..'replay_animation:group:',sela..'replay_audio:group:',sela..'replay_sticker:group:',sela..'replay_video:group:')
return "↯ 𖠲 تم مسح كل الردود العامه ."
else
return "↯ 𖠲 لا يوجد ردود عامه ليتم مسحها ."
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد عام' then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(sela..'delrdall:'..msg.sender_user_id_,true) 
return "↯ 𖠲 حسننا عزيزي  .\n↯ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "↯ 𖠲هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(sela..'delrd:'..msg.sender_user_id_,true)
return "↯ 𖠲 حسننا عزيزي  .\n↯ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "↯ 𖠲 *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(sela..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(sela..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(sela..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(sela..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(sela..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(sela..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(sela..'replay_video:group:'..msg.chat_id_)
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '↯ 𖠲لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '↯ 𖠲ردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "↯ 𖠲 للمطور فقط ." end
local names 	= redis:hkeys(sela..'replay:all')
local photo 	= redis:hkeys(sela..'replay_photo:group:')
local voice 	= redis:hkeys(sela..'replay_voice:group:')
local imation 	= redis:hkeys(sela..'replay_animation:group:')
local audio 	= redis:hkeys(sela..'replay_audio:group:')
local sticker 	= redis:hkeys(sela..'replay_sticker:group:')
local video 	= redis:hkeys(sela..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '↯ 𖠲لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '↯ 𖠲الردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
if not msg.Director then return "↯ 𖠲هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(sela..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "↯ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"↯هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(sela..'namebot:witting'..msg.sender_user_id_,300,true)
...
❈↞❬أوامر المسح❭
———————ᵴᵉᴌẦ—————
 𖠲↯مسح الادمنـيـه «» ❬لمسح الادمنيه❭
 𖠲↯مسح المميزين «» ❬لمسح المميزين❭
 𖠲↯ مسح المــــدراء «» ❬لمسح المدراء❭
———————ᵴᵉᴌẦ—————
❈↞❬أوامر الحظر والطرد والتقييد❭
———————𝒃𝒓𝒂𝒊𝒅𝒆𝒏 ♡—————
 𖠲↯ حظر ❬بالرد «» بالمعرف❭ لحظر العضو.
 𖠲↯ الغاء الحظر ❬بالرد «» بالمعرف❭ لإلغاء الحظر. 
 𖠲↯ طرد ❬بالرد «» بالمعرف❭ لطرد العضو.
 𖠲↯ كتم ❬بالرد «» بالمعرف❭ لكتم العضو. 
 𖠲↯ الغاء الكتم ❬بالرد«»بالمعرف❭لإلغاء الكتم. 
 𖠲↯ تقييد ❬بالرد «» بالمعرف❭ لتقييد العضو.
 𖠲↯ فك التقييد ❬بالرد «» بالمعرف❭ لإلغاء تقييد العضو.
 𖠲↯ منع + الكلمة «» لمنع كلمة داخل المجموعة.
 𖠲↯ الغاء منع «» لالغاء منع الكلمة.
—————— 𝒃𝒓𝒂𝒊𝒅𝒆𝒏 ♡——————
...
❈-❬أوامر الإعدادات❭
—————— 𝒃𝒓𝒂𝒊𝒅𝒆𝒏 ♡——————
 𖠲↯
————
✰↯  معـرف المـطور ↤︎ ↞ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Admin then return "↯ 𖠲هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if not redis:get(sela..'lave_me'..msg.chat_id_) then 
return "↯ 𖠲أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(sela..'lave_me'..msg.chat_id_) 
return "↯أهلا عزيزي "..msg.TheRankCmd.."\n↯ تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "↯ 𖠲هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if redis:get(sela..'lave_me'..msg.chat_id_) then 
return "↯ 𖠲أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(sela..'lave_me'..msg.chat_id_,true)  
...
❈︎︎︎︎ 👑-𝗦𝗼𝘂𝗿𝗰𝗲 𝗯𝗿𝗮𝗹𝗱𝗲𝗻-👑
▬▬▬▬▬▬▬▬
[𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥](t.me/ahhh_maaaa)
[𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥](t.me/A_B_D_hhh)
[𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥](t.me/KaSa7A11)
[𝗖𝗛𝗔𝗡𝗡𝗘𝗟](t.me/Braidn_1)
[𝗧𝗢 𝗧𝗔𝗟𝗞 𝗨𝗦](t.me/TW_Madison_bot)
▬▬▬▬▬▬▬▬
]]
end
...
return '↯ 𖠲عدد سحكاتك ⇜ ❪ '..(redis:get(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "↯ *│* لا يوجد سحكات لك في البوت ." end
redis:del(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "↯ 𖠲 *│*تم مسح {* "..rfih.." *} من سحكاتك .\n"
end

if MsgText[1] == "تفعيل الاشتراك الاجباري" or MsgText[1] == "تفعيل الاشتراك الاجباري ☑" then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(sela..":UserNameChaneel") then
return "↯ 𖠲 اهلا عزيزي المطور \n↯ الاشتراك بالتأكيد مفعل"
else
redis:setex(sela..":ForceSub:"..msg.sender_user_id_,350,true)
return "↯ 𖠲 مرحبا بـك في نظام الاشتراك الاجباري\n↯ الان ارسل معرف قـنـاتـك"
end
end

if MsgText[1] == "تعطيل الاشتراك الاجباري" or MsgText[1] == "تعطيل الاشتراك الاجباري" then
if not msg.SudoBase then return"↯هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(sela..":UserNameChaneel")
if SubDel == 1 then
return "↯ 𖠲 تم تعطيل الاشتراك الاجباري . \n✓"
else
return "↯ 𖠲 الاشتراك الاجباري بالفعل معطل . \n✓"
end
end
...
return "↯ 𖠲 لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
if redis:get(sela..'welc'..msg.chat_id_) == 'on' then
...
local hash = sela..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n↯ تم رفعه مشرف بكامل الصلاحيات\n‏‏')
...
mmd = redis:get(sela..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(sela..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(sela..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'↯ اهلا عزيزي \n↯ تم تثبيت الامر الجديد\n✓')
redis:del(sela..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(sela..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 اهلا بك عزيزي\n↯ الامر الي تريد تغيره الي  "'..cmd..'" \n↯ ارسله الان\n')
end

if Black and (Black:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')) then
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')
redis:hdel(sela..'CmD:'..msg.chat_id_,cmd)
redis:srem(sela..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"↯ 𖠲 اهلا عزيزي\nالامر >"..cmd.."\n↯ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(sela..'CmD:'..msg.chat_id_)
redis:del(sela..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"↯ 𖠲 اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(sela..'CmDlist:'..msg.chat_id_)
local t = '↯ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(sela..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(sela..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(sela..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(sela..'welc'..msg.chat_id_,'off')
redis:del(sela..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,sela)   
if sela.content_.ID == "MessageSticker" then        
local bd = sela.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(sela..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(sela..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*↯ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(sela..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس برايدن\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(sela..'users',msg.sender_user_id_)
if redis:get(sela..'lock_service') then 
text = [[↯ أهلاً انا بوت   []]..redis:get(sela..':NameBot:')..[[] 🗽
 𖠲↯ أختصاصي حماية المجموعات ..
 𖠲↯ مـن السبام والتوجيه والتكرار والخ..
 𖠲↯ لتفعيل البوت اتبع الشـروط ..
 𖠲1- اضف البوت الى المجموعه
 𖠲2- ارفع البوت مشرف في المجموعه
 𖠲3- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ــــــــــــــــــــــــــــــــ 𖠲ᵴᵉᴌẦ 𖠲ـــــــــــــــــــــــــ
...
text = [[↯ أهلاً انا بوت    []]..redis:get(sela..':NameBot:')..[[] 🗽
 ...
 𖠲1- اضف البوت الى المجموعه
 𖠲2- ارفع البوت مشرف في المجموعه
 𖠲③- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ـــــــــــــــــــــــــــــــــᵴᵉᴌẦــــــــــــــــــــــــ
 ↯ مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
local MSG_ID = (redis:get(sela.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
redis:setex(sela.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"↯ 𖠲 تم آرسـآل رسالتك إلى المطور\n↯ سـآرد عليك في اقرب وقت ممكن \n↯ معرف المطور "..SUDO_USER)
...
--====================== Reply Only Group ====================================
if redis:get(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(sela..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(sela..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(sela..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n↯ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(sela..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه صوره للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(sela..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه بصمه صوت للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(sela..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه متحركه للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(sela..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه فيديو للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(sela..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه للصوت للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(sela..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(sela..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(sela..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(sela..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ↯ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(sela..'replay_photo:group:',klma,photo_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه صوره للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(sela..'replay_voice:group:',klma,voice_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه بصمه صوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(sela..'replay_animation:group:',klma,animation_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه متحركه للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(sela..'replay_video:group:',klma,video_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه فيديو للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(sela..'replay_audio:group:',klma,audio_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه للصوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(sela..'replay_sticker:group:',klma,sticker_id)
redis:del(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(sela..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(sela..":ForceSub:"..msg.sender_user_id_)
...
redis:set(sela..":UserNameChaneel",msg.text)
...
if redis:get(sela..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(sela..'namebot:witting'..msg.sender_user_id_)
redis:set(sela..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"↯ تم تغير اسم البوت  .\n↯ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(sela..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(sela..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(sela..'replay_photo:group:',msg.text)
redis:hdel(sela..'replay_voice:group:',msg.text)
redis:hdel(sela..'replay_animation:group:',msg.text)
redis:hdel(sela..'replay_audio:group:',msg.text)
redis:hdel(sela..'replay_sticker:group:',msg.text)
redis:hdel(sela..'replay_video:group:',msg.text)
redis:setex(sela..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ جيد , يمكنك الان ارسال جوا ب الردالعام \n↯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(sela..'delrdall:'..msg.sender_user_id_) then
redis:del(sela..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(sela..'replay:all',msg.text)
local photo =redis:hget(sela..'replay_photo:group:',msg.text)
local voice = redis:hget(sela..'replay_voice:group:',msg.text)
local animation = redis:hget(sela..'replay_animation:group:',msg.text)
local audio = redis:hget(sela..'replay_audio:group:',msg.text)
local sticker = redis:hget(sela..'replay_sticker:group:',msg.text)
local video = redis:hget(sela..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'↯هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(sela..'replay:all',msg.text)
redis:hdel(sela..'replay_photo:group:',msg.text)
redis:hdel(sela..'replay_voice:group:',msg.text)
redis:hdel(sela..'replay_audio:group:',msg.text)
redis:hdel(sela..'replay_animation:group:',msg.text)
...
if redis:get(sela..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(sela..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(sela..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "↯ تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(sela..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(sela..'welcom:witting'..msg.sender_user_id_) 
redis:set(sela..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(sela..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(sela..'rulse:witting'..msg.sender_user_id_) 
redis:set(sela..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'↯ مرحبآ عزيزي\n↯ تم حفظ القوانين بنجاح .\n↯ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(sela..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(sela..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(sela..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(sela..'linkGroup'..msg.sender_user_id_,link) 
redis:set(sela..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'↯ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(sela..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(sela..'about:witting'..msg.sender_user_id_) 
...
if redis:get(sela..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(sela..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(sela..'users')  
local groups = redis:smembers(sela..'group:ids')
...
if redis:get(sela..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(sela..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(sela..'users')
if #pv >= 300 then
...
if redis:get(sela..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(sela..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(sela..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(sela..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(sela..':WELCOME_BOT'),[[↯أهلاً انا بوت ]]..redis:get(sela..':NameBot:')..[[
...
if msg.forward_info and redis:get(sela..'fwd:'..msg.sender_user_id_) then
redis:del(sela..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(sela..'users')
local groups = redis:smembers(sela..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(sela..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(sela..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(sela..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(sela..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(sela..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(sela..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(sela..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(sela..'replay:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(sela..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(sela..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ جيد , يمكنك الان ارسال جواب الرد \n↯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(sela..'delrd:'..msg.sender_user_id_) then
redis:del(sela..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(sela..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(sela..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(sela..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(sela..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(sela..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(sela..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(sela..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'↯هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(sela..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(sela..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(sela..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(sela..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(sela..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(sela..'welcome:msg'..msg.chat_id_) or "↯ اهلاً عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(sela..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(sela..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(sela..'welcome:msg'..msg.chat_id_) or "↯ اهلن بك عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(sela..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(sela..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(sela..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(sela..'welcome:get'..msg.chat_id_)
end
redis:setex(sela..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(sela..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(sela..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_sela = (redis:get(sela..'num_msg_sela'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_sela) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(sela..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"↯ العضو » "..USERNAME.."\n↯ قمـت بتكرار اكثر مـن "..NUM_MSG_sela.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(sela..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(sela..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(sela..'lock_woring'..msg.chat_id_) and not redis:get(sela..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(sela..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(sela..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(sela..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(sela..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(sela..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(sela..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(sela..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(sela..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(sela..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(sela..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(sela..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(sela..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(sela..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(sela..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(sela..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(sela..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(sela..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(sela..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(sela..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(sela..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(sela..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(sela..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(sela..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(sela..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(sela..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(sela..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(sela..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(sela..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(sela..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(sela..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(sela..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(sela..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(sela..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(sela..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(sela..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(sela..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(sela..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "ماديسون" or Text== " ماديسون" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس برايدن ♡](https://t.me/ahhh_maaaa)")
elseif Text== "كساحه" or Text== " كساحه" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس برايدن ♡](https://t.me/KaSa7A11)")
elseif Text== "الجاحد" or Text== "الجاحد" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس برايدن ♡](https://t.me/A_B_D_hhh)")
...
elseif Text== "رفع خول "  then return sendMsg(msg.chat_id_,msg.id_,"ٴ𐄬 أهلاً عزيزي\nٴ𐄬 تم رفع الخول بنجاح↯\nٴ𐄬 تمت إضافته إلى قائمه الخولات\n 𖠲")
elseif Text== "تنزيل خول"  then return sendMsg(msg.chat_id_,msg.id_,"ٴ𐄬 أهلاً عزيزي\nٴ𐄬 تم تنزيل الخول بنجاح↯\nٴ𐄬 تمت الزاله من قائمه الخولات\n 𖠲")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
 ...
 elseif Text== "ايديي" or Text=="ايدي ☆" then 
  ...
  elseif Text=="ابي رابط الحذف" or Text=="ابي رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" or Text=="رابط فارس" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "فارس" or Text== " ماديسون " or Text=="ماديسون" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/ahhh_maaaa) ")
...
if not redis:get('kar') then
  ...
  if redis:get(sela..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(sela..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'↯ انتهى الاشتراك في احد المجموعات .\n↯ المجموعه : '..FlterName(redis:get(sela..'group:name'..msg.chat_id_))..'.\n↯ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'↯ انتهى الاشتراك البوت.\n↯ سوف اغادر المجموعه فرصه سعيده .\n↯ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(sela..'ExpireDate:'..msg.chat_id_) / 86400)
