...
تم تطوير وبرمجة السورس من قبل مآديسؤن ☆
│@ahhh_maaaa ☆‿☆ 
---------------------------------------------------------------------
]]
...
redis:setex(sela..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"𖣐 |حسننا , الان يمكنك ارسال الاسم شكرا لستخدامك سورس برايدن ☆')    
return false
end

if redis:get(sela..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(sela..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
sendMsg(msg.chat_id_,msg.id_,"☆| لا يمكنك زخرفه اكثر من 20 حرف \n𖣐 | ارسل امر زخرفه وحاول مجددا بحروف اقل")    
return false
elseif msg.text:match("\n") then
sendMsg(msg.chat_id_,msg.id_,"𖣐 | لا يمكن زخرفه نص يحتوي على اكثر من سطر .")
return false
end
local EmojeS = {
' •🌱💚﴿ֆ ❥',
...
if msg.text and msg.type ~= "pv" and redis:get(sela..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(sela..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
...
.."`\n\n9- `"..Zhrf9..Emoje[math.random(#Emoje)]
.."`\n\n10- `"..Zhrf5..Emoje[math.random(#Emoje)]
Text_Zhrfa = Text_Zhrfa.."`\n\n✎| اضغط علي الاسم ليتم النسخ شكرا لستخدامك سورس سيلا \n✓"
sendMsg(msg.chat_id_,msg.id_,Text_Zhrfa)
return false
end
